...
class OpenAiService{
        ...
        array $restrictions): string
    {
        ...
        $complete = $open_ai->completion([
            ...
            Je vais pour finir te donner une liste de mes préférence lorsque je voyage : '.$interet_preference,'.
            et une liste de toute les choses dont je ne veux pas entendre parler pendant mon séjour : '.$restrictions,'
