...
class OpenAiService{
    ...
    public function getDestination(string $destination): string
    {
        ...
        $complete = $open_ai->completion([
            ...
            'prompt' => 'En tant qu\'expert Guide touristique, trouve moi 5 choses à faire en me faisant une liste. Reviens à la ligne et saute une ligne à chaque nouveau point. Donne un maximum de détail en citant la ville(s), le(s) restaurant(s), la plage(s). Pour un voyage de 2 semaines à'.$destination,
